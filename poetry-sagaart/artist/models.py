"""Данный модель предоставляет модель артиста и ассоциативную таблицу."""
...
class Artist(models.Model):
    ...
    class Meta:
        """Классс с метаданными для модели артиста."""

        verbose_name = "Автор"
        verbose_name_plural = "Авторы"

    def __str__(self):
        """Строковое представление экземпляра модели артиста."""
...
class FavoriteArtist(models.Model):
    ...
    class Meta:
        """Класс с метаданными для модели избранных художников."""
    ...
    def __str__(self):
        """Строковое представление экземпляра модели избранных художников."""
